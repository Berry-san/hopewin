    ...
    <>
      <div className="space-y-6">
        <h2 className="text-primary text-xl font-bold">
          Be the Change – Join Our Volunteer Team
        </h2>
        ...
        <ul className="list-disc list-inside">
          <li>Passion for social impact and community development</li>
          <li>A willingness to learn and work collaboratively </li>
          <li>
            Commitment to respecting the dignity and privacy of all those we
            serve
          </li>
        </ul>
        <h2 className="text-primary text-xl font-bold">Contact Us </h2>
        <p className="text-base font-medium">
          For questions or more information about volunteering, please email us
          at{' '}
          <a
